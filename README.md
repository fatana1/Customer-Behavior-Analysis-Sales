...
oAggregations (SUM, AVG, COUNT) 
oGrouping and filtering data 
oBusiness-specific insights (KPIs, trends) 
...
oKPI cards 
oTrend charts 
oCategory-wise breakdowns 
oSlicers and filters for interactivity 
